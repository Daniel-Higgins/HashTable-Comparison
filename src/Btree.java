...
public class Btree implements java.io.Serializable {
    ...
    static final String F = "src\\btree\\BtreeData";
    ...
    class Node implements java.io.Serializable {
        ...
        int childNode;//cn amount in children
        int n;//n amount of keys in array
        int key[];
        Long children[];
        int leaf;//4
        long id;//8
    ...
    private void splitchild(Node x, Node y) throws IOException {
        idt++;
        Node z = new Node(idt);
        z.leaf = y.leaf;
    ...
    private void diskwrite(Node x) throws IOException {
        try {
            ...
            b.putInt(x.childNode);
            for (int i = 0; i < x.childNode; i++) {
    ...
    private Node diskread(long x) throws Exception {
        try {
            ...
            t.childNode = b.getInt();
            for (int i = 0; i < t.childNode; i++) {
